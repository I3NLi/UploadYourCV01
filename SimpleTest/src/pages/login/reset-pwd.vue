...
<template>
  <el-form v-loading="state.loading" :model="form" :rules="rules" label-width="auto">
    <header>
      <text>HIYIO</text>
      <h1>重置密码</h1>
      <router-link to="/login/pwd-login">返回登录</router-link>
    </header>
    ...
    <el-form-item>
      <el-button class="submit" type="primary" @click="() => state.loading=true">确定</el-button>
    </el-form-item>
  </el-form>
</template>
